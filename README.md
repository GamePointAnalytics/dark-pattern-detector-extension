...
> "Don't let websites trick you into clicking."

![Extension Icon](dark-pattern-detector-extension/images/icon.svg)
...
*   **10 Detection Categories**:
    ...
    *   ☑️ **Preselection**: Pre-checked newsletter boxes.
...
We welcome contributions! Please check the issues tab for open tasks.
