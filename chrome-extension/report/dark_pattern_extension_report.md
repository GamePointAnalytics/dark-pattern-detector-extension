...
1.  **Clone the Repository**:
    ...
    ```
    Or download the zip file from the repository (https://github.com/GamePointAnalytics/dark-pattern-detector-extension/raw/main/chrome-extension/zip/DarkPatternDetectorExtension.zip) and extract it to your local machine.
